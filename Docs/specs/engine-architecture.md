...
- The project’s 1000-English-character target is an internal diagnostic or design target, not an official Midjourney limit. Existing word budgets remain the blocking policy until a separate decision defines whether characters include spaces, punctuation, and the final parameter tail.
