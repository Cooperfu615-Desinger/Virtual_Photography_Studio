...
- Normal single-subject AI retains the direct identity lead, projected body anchors, one compact facial-feature anchor, and the selected expression/gaze source. Character Card uses its permanent identity anchors instead of appending a duplicate normal face clause. Half-face composition wording is outside this change and remains unchanged.
