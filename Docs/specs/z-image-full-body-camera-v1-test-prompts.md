...
請觀察全身完整度、透視是否連續、身體結構與場景融合。蟲眼是刻意透視誇張，不等於自然體態；高位／鳥瞰／正上方須另做影像驗收。規格見 [六組規則](z-image-full-body-camera-v1.md)。
...
The setting is traditional Japanese washitsu room, tatami flooring, shoji sliding doors. Full-body portrait, eye-level view, front view. Her entire figure is framed with natural-looking proportions. Photographed directly from the front. Her chest and pelvis face the lens, with both shoulders, both hips, legs, and feet forming a frontal full-body silhouette.
...
The setting is traditional Japanese washitsu room, shoji sliding doors, a wooden lintel above the shoji doors. Full-body portrait, front view. The camera is positioned near floor level, set back from her and tilted upward to include her entire figure from head to feet. The upward perspective is clear, with a gradual change in scale along her body. Photographed directly from the front. Her chest and pelvis face the lens, with both shoulders, both hips, legs, and feet forming a frontal full-body silhouette.
