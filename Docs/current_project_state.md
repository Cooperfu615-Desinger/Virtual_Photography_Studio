...
- `npm run test:prompt-quality` runs the contract, representative-fixture, conservative deduplication, and composition-visibility integration gates. The 2026-07-18 result is 16 passed.
