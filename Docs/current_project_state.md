...
- `npm run test:prompt-quality` runs the contract, representative-fixture, conservative deduplication, composition-visibility integration, and fixed-composition cross-output integration gates. The 2026-07-19 result is 26 passed.
