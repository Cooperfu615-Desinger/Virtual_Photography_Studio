...
- `npm run test:prompt-quality` runs the contract, representative-fixture, conservative deduplication, composition-visibility integration, normal-single and compatibility-source body-visibility integration, the phase-4 body matrix, fixed-composition cross-output integration, and fixed-framing phase-1 structural plus phase-2 infrastructure gates. The 2026-07-22 result is 54 passed.
