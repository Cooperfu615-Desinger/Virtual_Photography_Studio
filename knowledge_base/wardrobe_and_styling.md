...
| :--- | :--- | :--- | :--- |
| **套裝 (Outfit Presets)** | 亮面乳膠束帶套裝 | `wearing a glossy high-cut latex one-piece bodysuit, exposed arms and legs, sculpted second-skin fit, strategic waist and side cut-outs, harness-style strapping, belt accents, front zipper hardware, polished fetish-inspired fashion detailing` | 以高衩連身泳裝式乳膠輪廓為核心，露出手臂與腿部，並加入局部鏤空、束帶、皮帶與拉鍊五金，整體更像完整的精緻時裝化 fetish 造型；配色應由獨立的套裝配色控制。 |
| **套裝 (Outfit Presets)** | 皮革馬甲束腰套裝 | `wearing a structured corset-bodice one-piece outfit, pronounced waist-cinching shape, polished leather panel construction, refined bust shaping, lace trim, delicate embroidery accents, lingerie-inspired lower detailing, suspender-style lace stockings, ornate sensual couture finish` | 以皮革馬甲式胸衣與束腰輪廓為核心，加入蕾絲滾邊、刺繡裝飾、精緻胸型結構與吊帶襪式細節，保留誘惑感但更偏高級精緻的時裝內衣語言；配色應由獨立的套裝配色控制。 |
