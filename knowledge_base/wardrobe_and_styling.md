...
| :--- | :--- | :--- | :--- |
| **風格基調 (Vibe)** | 賽博龐克 (Cyberpunk) | `cyberpunk aesthetic, high-tech dystopian, neon lit fashion, futuristic streetwear` | 充滿未來感、高科技與反烏托邦色彩，通常伴隨反光材質與霓虹燈效。 |
| **風格基調 (Vibe)** | 千禧復古 (Y2K) | `Y2K fashion, early 2000s aesthetic, retro-futurism, low-rise, baby tees` | 千禧年初期風格，色彩鮮豔、帶點塑膠感與金屬光澤，懷舊又叛逆。 |
| **風格基調 (Vibe)** | 機能風 (Techwear) | `techwear fashion, utilitarian clothing, tactical aesthetic, functional gear, urban ninja` | 重視機能性與多重口袋、扣環設計，防潑水材質，都市忍者般的戰術感。 |
| **風格基調 (Vibe)** | 極簡高級 (Minimalist Luxury) | `quiet luxury, minimalist fashion, clean lines, monochromatic, tailored fit` | 無明顯 logo，剪裁俐落乾淨，注重面料垂墜與高質感。 |
| **風格基調 (Vibe)** | 法式慵懶 (Parisian Chic) | `effortless Parisian chic, relaxed elegance, unpretentious fashion, natural charm` | 看似隨性但不隨便的優雅，強調舒適感與不刻意的時尚感。 |
| **風格基調 (Vibe)** | 復古龐克 (Retro Punk) | `retro punk fashion, rebellious aesthetic, DIY aesthetic, edgy, distressed` | 帶有破壞感、鉚釘、皮革、格紋等元素，散發叛逆與次文化氣息。 |
| **風格基調 (Vibe)** | 日系街頭 (Japanese Streetwear) | `Japanese streetwear, oversized silhouette, layered clothing, Harajuku fashion` | 擅長多層次穿搭與 oversized 廓形，混合工裝與日常單品。 |
| **風格基調 (Vibe)** | 民俗風 (Bohemian/Ethnic) | `bohemian fashion, ethnic style, folk aesthetic, embroidered pieces, earth tones` | 刺繡、流蘇、圖騰印花與大地色系，充滿異國情調與自由奔放感。 |
| **風格基調 (Vibe)** | BDSM (拘束/束縛) | `BDSM fashion, bondage aesthetic, fetish wear, leather harnesses, latex accents` | 強烈的束縛感與支配性，使用皮革、乳膠、綁帶與金屬環等元素。 |
| **風格基調 (Vibe)** | 巴洛克 (Baroque) | `Baroque fashion, opulent aesthetic, ornate gold embroidery, luxurious fabrics, decadent` | 極致奢華與繁複，大量金色刺繡、天鵝絨、絲綢與戲劇化剪裁。 |
| **風格基調 (Vibe)** | 維多利亞 (Victorian) | `Victorian aesthetic, gothic Victorian, high neck lace, corsets, romantic mourning dress` | 帶有禁慾與浪漫氣息，高領蕾絲、緊身馬甲與繁複皺褶。 |
| **風格基調 (Vibe)** | 蘿莉塔 (Lolita) | `Lolita fashion, sweet/gothic lolita, bell-shaped skirt, frills, rococo inspired` | 源自日本的洛可可風格，標誌性的鐘形裙襬、大量荷葉邊與蝴蝶結。 |
| **風格基調 (Vibe)** | 女高中生 (JK/Schoolgirl) | `JK uniform, Japanese school uniform aesthetic, sailor suit, pleated skirt, preppy` | 經典日本女子高校制服，包含水手服、百褶裙、西裝外套與針織衫。 |
| **風格基調 (Vibe)** | 內衣 (Lingerie) | `lingerie aesthetic, boudoir fashion, sheer intimates, lace bodysuit, provocateur` | 展現身體曲線，以透膚蕾絲、絲綢為主的私密性感穿搭。 |
| **風格基調 (Vibe)** | 泳裝 (Swimwear) | `swimwear fashion, bikini top, one-piece swimsuit, beach aesthetic, resort wear` | 海灘或度假風格，包含比基尼、連身泳衣與度假罩衫。 |
...
| **上身 (Tops)** | 粗針織寬鬆毛衣 | `chunky knit oversized sweater, cable knit, heavy yarn texture` | 帶有份量感的粗毛線編織，溫暖且有慵懶居家氛圍。 |
| **上身 (Tops)** | 短版緊身吊帶背心 | `cropped tight camisole, ribbed cotton tank top, form-fitting` | 貼身露腰、偏 Y2K 與街頭感。 |
| **上身 (Tops)** | 解構主義不對稱上衣 | `deconstructed asymmetric top, avant-garde cut, uneven hem` | 剪裁不對稱、偏前衛藝術感。 |
| **上身 (Tops)** | 機能戰術背心 | `tactical utility vest, multiple pockets, nylon straps, webbing` | 多口袋、織帶與插扣，強化機能戰鬥感。 |
| **上身 (Tops)** | 金屬光澤馬甲上衣 | `metallic corset top, structured bodice, iridescent finish` | 帶立體支撐與金屬反光感，適合強風格時裝畫面。 |
...
| **褲裝 (Pants)** | 西裝短褲 | `tailored shorts, structured suiting fabric, clean hemline` | 俐落正式但保留輕盈感，適合夏季時裝與城市造型。 |
...
| **裙裝 (Skirts)** | 龐克格紋百褶裙 | `punk tartan pleated skirt, red and black plaid, safety pin accents` | 經典格紋、叛逆氣息強。 |
| **裙裝 (Skirts)** | 亮面漆皮迷你裙 | `glossy patent leather mini skirt, high shine texture, a-line` | 反光感強烈，適合夜景與 fetish 邊緣風格。 |
...
| **外套 (Outerwear)** | 丹寧拼接解構外套 | `deconstructed patchwork denim jacket, raw edges, mismatched wash` | 布邊外露、手工感強。 |
...
| **鞋款 (Shoes)** | 厚底綁帶軍靴 | `chunky platform combat boots, thick lug sole, heavy leather` | 增添下半身重量感與龐克氣息。 |
...
| **鞋款 (Shoes)** | 金屬光澤尖頭高跟鞋 | `metallic pointed-toe stilettos, glossy reflective finish, sharp silhouette` | 攻擊性與戲劇感較強，適合夜晚與強風格時裝。 |
| **鞋款 (Shoes)** | 漆皮過膝長靴 | `patent leather thigh-high boots, sleek fetish-inspired silhouette` | 緊貼腿部線條，適合夜景、飯店與 fetish 邊緣主題。 |
