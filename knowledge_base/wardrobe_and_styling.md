...
| :--- | :--- | :--- | :--- |
| **套裝 (Outfit Presets)** | 亮面乳膠束帶套裝 | `wearing a glossy high-cut latex one-piece bodysuit with a halter neckline, deep zip-front plunge, dramatic torso cut-out, sculpted second-skin fit, opera-length gloves, integrated choker collar, double buckle hip straps, thigh harness straps, polished hardware accents, fetish-inspired couture detailing` | 以高衩連身泳裝式乳膠輪廓為核心，加入頸圈式領口、前中深開拉鍊、腹部大面積鏤空、長手套、髖部雙皮帶與腿部束帶，整體更接近完整的時裝化 fetish 造型；配色應由獨立的套裝配色控制。 |
| **套裝 (Outfit Presets)** | 皮革馬甲束腰套裝 | `wearing a structured leather corset-bodice one-piece outfit, pronounced waist-cinching shape, sculpted bra-cup construction, refined bust shaping, embroidered lace trim, ornate panel detailing, delicate lingerie-inspired lower styling, suspender-style lace stockings, couture boudoir finish` | 以皮革馬甲式胸衣與束腰輪廓為核心，加入立體胸杯結構、蕾絲滾邊、刺繡拼片與更精緻的下身內衣式細節，整體更偏高級精緻、帶 boudoir 感的時裝內衣語言；配色應由獨立的套裝配色控制。 |
