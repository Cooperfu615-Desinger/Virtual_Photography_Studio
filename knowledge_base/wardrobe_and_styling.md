...
| :--- | :--- | :--- | :--- |
| **套裝 (Outfit Presets)** | 亮面乳膠束帶套裝 | `ultra-detailed fetish couture portrait, woman wearing a tightly sculpted glossy latex one-piece with a halter neckline, dramatic zip-front plunge, bold torso cut-out, high-cut leg line, integrated choker collar, opera-length latex gloves, double buckle hip straps, thigh harness straps, polished metallic hardware, rich liquid-like shine, sleek second-skin contour, editorial fetish fashion finish` | 以亮面乳膠連身輪廓為核心，強調頸圈式領口、深拉鍊前襟、腹部鏤空、高衩腿線、長手套、髖部雙皮帶與腿部束帶，整體更接近高細節、強五金感的時裝化 fetish couture 造型；配色應由獨立的套裝配色控制。 |
| **套裝 (Outfit Presets)** | 皮革馬甲束腰套裝 | `ultra-detailed couture boudoir portrait, woman wearing a tightly-laced structured leather corset-bodice one-piece, dramatic hourglass tailoring, sharply cinched waist, sculpted overbust cup construction, rich glossy leather with subtle patent sheen, lavish floral embroidery, dense French lace trims and appliques, ornate boned panels with metallic grommets, buckle hardware and ring connectors, satin ribbon lacing, plunging sweetheart neckline, sheer mesh and lace paneling through the lower half, high-cut leg line, refined sensual couture finish` | 以皮革馬甲式胸衣與束腰輪廓為核心，加入立體胸杯結構、更繁複的法式蕾絲與花卉刺繡、骨架拼片、金屬孔眼、扣件與環狀五金，以及更精緻的網紗蕾絲下身細節，整體更偏高級精緻、帶 boudoir 感的時裝內衣語言；配色應由獨立的套裝配色控制。 |
| **套裝 (Outfit Presets)** | 玫瑰粉乳膠迷你洋裝套裝 | `wearing a glossy latex mini dress, ultra-detailed latex sheen, sculptural silhouette, niche fetish-fashion mood, dominant dress color controlled by the outfit color selection` | 以亮面乳膠迷你洋裝本體為主，保留夢幻又強烈的 fetish fashion 氣質，但顏色不寫死，改由套裝配色控制。 |
| **套裝 (Outfit Presets)** | 象牙白春日巴黎套裝 | `wearing a silk camisole layered under an oversized linen shirt left open with high-waisted wide-leg trousers, silky sheen, airy linen layers, effortless Parisian spring styling, coordinated tonal palette controlled by the outfit color selection` | 以絲質細肩帶、寬鬆亞麻襯衫與高腰寬褲構成的巴黎春日穿搭為核心，保留輕盈鬆弛的 tone-on-tone 層次感，但不固定象牙白、白色與淺灰，整體改由套裝配色控制。 |
...
| **套裝 (Outfit Presets)** | 全黑長版襯衫百褶長裙套裝 | `wearing an oversized long button-up shirt layered over a flowing pleated maxi skirt, soft draped silhouette, understated austere elegance, quiet editorial styling, dominant outfit color controlled by the outfit color selection` | 以寬鬆長版襯衫外搭百褶長裙的修長垂墜輪廓為核心，整體安靜、克制，帶一點極簡修道感與文藝時裝氣質；不再固定全黑，主色改由獨立配色控制。 |
...
| **套裝 (Outfit Presets)** | 黑色細節一字領哥德洋裝套裝 | `wearing an off-shoulder mini dress with smooth soft fabric, wide elastic neckline, scalloped collar edge, fully off-shoulder style, long soft balloon sleeves with gathered cuffs, fitted high waist, loose A-line silhouette, mini length, front vertical black ribbon detail, small black buttons aligned on the chest, decorative black bow at the neckline, black choker ribbon around the neck, thin shoulder straps visible under the neckline, layered hem, black sheer underskirt with lace trim visible beneath the dress, delicate lace edge, clean soft gothic style, dominant main dress color controlled by the outfit color selection while all black contrast details remain fixed` | 以一字領、寬鬆長袖、高腰 A-line 迷你洋裝與柔和哥德感為主，主體洋裝顏色交由套裝配色控制；黑色緞帶、胸前小鈕扣、領口蝴蝶結、choker、肩帶與黑色透紗蕾絲內襯固定保留。 |
| **套裝 (Outfit Presets)** | 銀色亮面深V掛脖迷你洋裝套裝 | `wearing a metallic halter mini dress with a plunging deep-V neckline, body-contouring fit, glossy reflective fabric, sleek nightlife glamour silhouette, bold feminine party styling, dominant dress color controlled by the outfit color selection` | 以亮面金屬感材質、深 V 掛脖領口與貼身迷你洋裝輪廓為核心，整體偏夜拍、派對、精品夜生活感，強調反光材質與成熟性感線條；顏色不再固定銀色，改由套裝配色控制。 |
...
| **套裝 (Outfit Presets)** | 內衣寫真套裝 | `wearing a lingerie-inspired outfit with sheer floral lace, scalloped trim, satin ribbon accents, underwire bra styling, matching low-rise lace bottoms, boudoir styling, seductive body-skimming silhouette` | 以透膚花卉蕾絲、波浪滾邊、緞帶點綴、帶鋼圈胸衣結構與低腰成套下身為核心，整體更偏性感、貼身且帶 boudoir 氛圍的內衣寫真造型。 |
| **套裝 (Outfit Presets)** | 泳裝度假套裝 | `wearing a classic triangle bikini top with slim halter strings, minimal sliding triangle cups, smooth stretch swim fabric, paired with low-rise side-tie bikini bottoms, string-tied hips, clean beachwear silhouette, resort mood, sunlit vacation elegance` | 改成與上下身比基尼單件一致的經典泳裝結構，上身是細繩肩帶與簡潔三角罩杯，下身是兩側綁帶的低腰比基尼褲型，整體維持俐落直接的海邊與度假感。 |
...
| **套裝 (Outfit Presets)** | 兔女郎套裝 | `wearing a bunny girl outfit, fitted corset bodice, satin or stretch fabric finish, sweetheart neckline, structured bodysuit silhouette, crisp contrast cuffs and collar, playful rabbit-ear headband, polished cabaret styling, dominant main fabric color controlled by the outfit color selection while the cuffs and collar remain a clean contrast detail` | 以兔耳頭飾、貼身馬甲式連身輪廓、袖口與領圈構成的高辨識度主題套裝，適合夜景、棚拍、派對與角色扮演感畫面；主體顏色改由套裝配色控制，袖口與領圈保留乾淨的對比細節。 |
...
| **套裝 (Outfit Presets)** | 女僕風荷葉比基尼套裝 | `maid-inspired lingerie costume set, frilled maid headband, ruffled neck collar with small ribbon bow, triangle bra top with slim straps, ruffled low-rise bikini-style bottoms, side-tie bow accents at the hips, matching ruffled wrist cuffs, playful costume-lingerie styling, dominant main fabric color controlled by the outfit color selection, contrast ruffle trims and ribbon details coordinated without fixed color` | 參考附圖中的女僕風內衣套裝結構：荷葉頭飾、頸部荷葉領與蝴蝶結、三角罩杯上身、荷葉邊低腰下身、側綁帶與手腕荷葉袖口；不指定固定顏色，主色由套裝配色控制，荷葉與緞帶作為對比細節保留變化。 |
...
| **套裝 (Outfit Presets)** | 復古雙排釦洋裝套裝 | `wearing a classic elegant dress outfit, one-piece dress with tailored structure, high waist design, slightly flared skirt, smooth fabric with gentle sheen, double-breasted bodice with two rows of gold buttons, short cropped jacket-like upper section integrated into the dress, ruffled collar with lace trim, ribbon bow at the neckline, long sleeves with gathered cuffs, cuffs finished with lace frill, subtle pocket details with contrast trim accents, skirt hem decorated with a thin contrast stripe and a delicate inner accent line, lace underskirt visible beneath the hem, refined vintage style, clean silhouette with soft folds and detailed stitching` | 以高腰洋裝、雙排金釦胸身、短版外套式上半身結構、荷葉蕾絲領、蝴蝶結領口與袖口蕾絲為重點的復古套裝，裙襬再以對比細條、內側裝飾線與蕾絲襯裙收尾；整體更偏精緻古典、制服感與 vintage dress styling，主色與對比色應由獨立的套裝配色控制。 |
...
| **頸部 (Neck Accessories)** | 皮質扣環頸鏈 | `leather buckle choker detail, subtle edgy neck accent` | 保留冷感與地下風格，但避免變成過強主題道具。 |
