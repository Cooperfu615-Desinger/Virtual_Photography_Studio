...
| **表情 (Facial Expression)** | 柔和微笑 | `soft natural smile, relaxed brows, gently narrowed eyes, softly parted lips, lifted cheeks` | 自然柔和的微笑，眉毛放鬆，眼睛微微收窄，嘴唇微張，臉頰抬起。 |
| **表情 (Facial Expression)** | 平靜淡然 | `calm composed expression, relaxed brows, softly open eyelids, neutral closed mouth, even facial muscles` | 平靜淡然的表情，眉毛放鬆，眼瞼自然張開，嘴唇閉合，臉部肌肉均勻放鬆。 |
| **表情 (Facial Expression)** | 無辜清透 | `delicate innocent expression, relaxed brows, softly open eyes, gently closed lips, relaxed cheek muscles` | 細緻無辜的表情，眉毛放鬆，眼睛自然張開，嘴唇輕閉，臉頰保持柔和。 |
| **表情 (Facial Expression)** | 俏皮忍笑 | `playful restrained smile, relaxed brows, gently narrowed eyes, pressed lips, subtly lifted mouth corners` | 俏皮地忍住笑意，眉毛放鬆，眼睛微微收窄，嘴唇輕抿，嘴角微微上揚。 |
| **表情 (Facial Expression)** | 若有所思 | `thoughtful reflective expression, slightly drawn inner brows, softened eyelids, relaxed lips, subtle facial tension` | 若有所思的表情，眉心略微收緊，眼瞼柔和，嘴唇放鬆，臉部帶輕微張力。 |
| **表情 (Facial Expression)** | 內斂克制 | `reserved understated expression, relaxed eyelids, gently pressed lips, neutral brows, restrained facial tension` | 內斂克制的表情，眼瞼放鬆，嘴唇輕抿，眉毛保持中性，臉部張力收斂。 |
| **表情 (Facial Expression)** | 溫柔含蓄 | `gentle demure expression, relaxed brows, softly open eyelids, softly closed lips, relaxed cheeks` | 溫柔含蓄的表情，眉毛放鬆，眼瞼自然，嘴唇柔和閉合，臉頰放鬆。 |
| **表情 (Facial Expression)** | 沉浸平靜 | `calm absorbed expression, softly lowered eyelids, relaxed brows, softly closed lips, relaxed facial muscles` | 平靜沉浸的表情，眼瞼柔和下垂，眉毛放鬆，嘴唇輕閉，臉部肌肉安定。 |
| **表情 (Facial Expression)** | 自然喜悅 | `candid joyful expression, lifted cheeks, eyes gently narrowed by the smile, open genuine smile, visible teeth` | 自然喜悅的表情，臉頰抬起，眼睛因微笑而收窄，露出自然真實的笑容與牙齒。 |
| **表情 (Facial Expression)** | 撒嬌生氣 | `playful mock-angry expression, lightly furrowed brows, small pout, subtly puffed cheeks, restrained smile` | 俏皮假裝生氣，眉毛微皺，輕微嘟嘴、鼓起臉頰，同時保留收斂笑意。 |
| **表情 (Facial Expression)** | 內斂悲傷 | `restrained sad expression, inner brows slightly raised, softened eyelids, mouth corners slightly downturned, subtle lower-lip tension` | 克制而安靜的悲傷表情，眉毛內側略抬，眼瞼柔化，嘴角微微下垂，下唇帶細微張力。 |
...
| **姿勢與肢體語言 (Pose & Body Language)** | 站姿｜雙手自然垂放 | `standing pose with arms naturally at sides, simple clean posture, unforced body line` | 雙手自然下垂，畫面乾淨，適合簡約人像。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 站姿｜雙臂交疊 | `standing pose with loosely crossed arms, relaxed closed posture, cool composed body language` | 手臂自然交疊在身前，身體線條收斂而穩定。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 坐姿｜自然坐姿 | `natural seated pose, relaxed upright sitting posture, everyday calm body language` | 坐姿穩定放鬆，上半身自然伸展。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 坐姿｜微微前傾 | `seated pose leaning slightly forward, engaged natural posture, subtle interactive body language` | 上半身稍微前傾，讓人物更靠近鏡頭且更有參與感。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 坐姿｜雙手後撐 | `seated pose with both hands placed behind for support, open chest, relaxed stretched posture` | 雙手向後撐住身體，姿態放鬆並帶伸展感。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 坐姿｜單腿放鬆 | `asymmetrical seated pose with one leg relaxed, casual uneven body rhythm, natural sitting line` | 一側腿部較放鬆延伸，另一側自然收起，形成不對稱節奏。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 坐姿｜雙腿自然伸展 | `seated pose with legs naturally extended, loose comfortable posture, laid-back body language` | 腿部自然往前延伸，不過度端正，保留輕鬆感。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 坐姿｜盤腿坐姿 | `cross-legged seated pose, relaxed casual sitting posture, intimate everyday body language` | 雙腿自然盤起，姿勢輕鬆，適合私密生活感構圖。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 坐姿｜側身坐姿 | `side-facing seated pose, slightly turned torso, natural dimensional sitting posture` | 身體略微側向鏡頭，避免正面坐直的僵硬感。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 坐姿｜抱膝坐姿 | `seated pose hugging knees, compact self-contained posture, quiet relaxed body language` | 雙手或手臂自然抱膝，身體線條較集中而收斂。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 半躺低姿態｜側身半躺 | `side reclined pose, body gently extended, relaxed low posture, soft flowing body line` | 身體側向延展，整體姿勢放鬆，適合柔和低姿態畫面。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 半躺低姿態｜正面仰躺 | `relaxed supine pose, lying on her back facing upward, one arm raised loosely above the head, the other resting casually beside the body, legs bent naturally in a soft asymmetrical way, upright non-inverted body orientation` | 正面朝上的舒服仰躺姿勢，手腳自然不對稱，避免頭下腳上的倒置構圖。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 半躺低姿態｜手撐半躺 | `reclined pose supported by one arm, lifted upper body, natural relaxed asymmetry` | 以單手或手肘支撐上半身，讓姿勢更有層次。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 半躺低姿態｜微蜷放鬆 | `slightly curled relaxed low pose, soft compact body line, intimate restful posture` | 身體略微收起，帶休息感、柔軟感與生活感。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 半躺低姿態｜趴姿 | `low prone pose, upper body close to the surface, relaxed intimate body line` | 上半身接近低平面，身體趴臥放鬆，適合低姿態構圖。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 半躺低姿態｜側躺延伸 | `elongated side-lying pose, extended body line, calm graceful low posture` | 身體橫向延展，線條完整，適合全身構圖。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 蹲姿｜自然蹲姿 | `natural squatting pose, relaxed low posture, balanced body weight, casual grounded body language` | 身體自然下蹲，重心穩定不誇張。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 蹲姿｜單膝蹲姿 | `one-knee squat pose, asymmetrical low stance, stable grounded posture, natural visual rhythm` | 一膝較低、一膝支撐，姿態更有層次。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 蹲姿｜手扶膝蓋蹲姿 | `squatting pose with one hand resting on knee, relaxed low stance, casual confident body language` | 下蹲時手自然扶在膝上，姿態清楚且穩定。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 動態｜輕步移動 | `light stepping motion, subtle body movement, natural transitional pose, candid rhythm` | 像正在慢慢走動或移動重心，避免人物太靜止。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 動態｜整理頭髮 | `adjusting hair while moving, candid grooming gesture, natural in-between motion` | 手正在整理頭髮，像被捕捉到的自然瞬間。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 動態｜整理衣襬 | `adjusting clothing hem, subtle styling gesture, candid everyday movement` | 手碰觸衣物或衣襬，帶自然日常的整理動作。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 動態｜抬手整理肩頸 | `hand lifting toward shoulder or neck, soft adjustment gesture, delicate natural motion` | 手靠近肩頸、鎖骨或耳側，適合細膩近景人物狀態。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 動態｜回身動作 | `body turning in motion, torso rotating naturally, transitional pose with subtle tension` | 身體正在轉向或回身，增加動勢與不僵硬的過渡感。 |
| **姿勢與肢體語言 (Pose & Body Language)** | 動態｜停步姿勢 | `just-stopped movement pose, stillness after motion, balanced transitional body language` | 像剛停下腳步的狀態，保留動作後的穩定停格。 |
| **特殊動作 (Special Actions)** | 全無 | `none` | 不指定特殊動作，保留一般姿勢動作系統。 |
| **特殊動作 (Special Actions)** | 塗口紅 | `applying lipstick with the lipstick bullet pressed to the lips, visible hand-to-mouth contact, slight lip pressure, polished beauty touch-up portrait moment` | 以口紅膏體實際接觸嘴唇的補妝瞬間為主，重點是嘴唇因接觸與施力而出現些微擠壓變形，帶明確的美容行為與近距離寫真感。 |
| **特殊動作 (Special Actions)** | 塗歪口紅 | `messy lipstick application with the lipstick bullet touching the mouth, color smudged beyond the lip line, visible hand contact, imperfect beauty close-up moment` | 以手持口紅實際往嘴唇塗抹、並且塗出唇線外的失手感或刻意塗歪效果為主，強調口紅道具清楚可見、顏色外溢、邊緣暈開與不完美的近距離美容特寫。 |
| **特殊動作 (Special Actions)** | 喝冰咖啡 | `holding a clear plastic takeaway cup of iced coffee near the lips mid-sip, visible straw or cup rim, relaxed everyday cafe portrait moment` | 以手持透明外帶塑膠杯裝的冰咖啡準備啜飲或剛啜飲的瞬間為主，重點是杯身清楚可見、帶生活感與刻意擺拍兼具的日常咖啡情境。 |
| **特殊動作 (Special Actions)** | 咬著波板糖 | `biting a colorful whirly pop swirl lollipop at the lips, candy prop clearly visible, playful portrait interaction with crisp mouth contact` | 以咬著波板糖的瞬間為主，讓糖果本身成為明確視覺道具，帶一點俏皮與角色感，同時保留乾淨直接的人像構圖。 |
| **特殊動作 (Special Actions)** | 抽煙 | `holding a cigarette between the fingers near the lips, faint smoke close to the face, controlled cinematic portrait gesture` | 以手指夾著香菸靠近嘴邊的瞬間為主，煙霧只作為輕量氛圍，不讓道具過度主導畫面。 |
| **特殊動作 (Special Actions)** | 整理絲襪 | `one hand pulling up a stocking on one leg, clear hosiery adjustment, visible hand-leg contact, fashion dressing gesture` | 以單手拉起一側絲襪的穿戴整理動作為主，需要至少能清楚看到腿部與手部互動。 |
| **特殊動作 (Special Actions)** | 前傾抓住褲腰 | `standing forward lean from the waist, both hands gripping the front waistband or belt loops, elbows angled outward, shoulders forward, energetic close-interaction pose` | 以上半身從腰部向鏡頭前傾、雙手抓住褲腰兩側或皮帶環為主，手肘向外、肩膀前壓、臀部微微向後，帶有靠近鏡頭的互動感；不綁定特定場景。 |
| **特殊動作 (Special Actions)** | 側坐單手後撐 | `side-saddle seated pose with both legs folded to one side, one hand planted behind the body, torso leaning back, relaxed asymmetrical support` | 以側坐、雙腿折向一側、一手在身後或身側支撐身體的動作為主，不綁定特定場景或道具。 |
| **特殊動作 (Special Actions)** | 抱膝托腮坐姿 | `seated pose with knees drawn close to the chest, elbows near the knees, both hands cupping the cheeks, intimate front-facing seated posture` | 以膝蓋靠近胸前、雙手托腮、手肘靠近膝蓋的正面坐姿為主，不綁定特定場景或道具。 |
| **特殊動作 (Special Actions)** | 仰躺雙手微抬 | `lying on her back, arms bent beside the shoulders, hands softly lifted near the head, calm open upper-body resting pose` | 以仰躺、雙手在肩膀或頭部兩側自然微抬的休息動作為主，不綁定特定場景或道具。 |
| **特殊動作 (Special Actions)** | 跪坐回眸撩髮 | `kneeling seated pose with the body turned away, looking back over the shoulder, one hand touching the hair near the head, over-the-shoulder portrait action` | 以跪坐或坐在小腿上的回眸姿態為主，身體背向鏡頭、一手抬起觸碰頭髮，不綁定特定場景或道具。 |
| **特殊動作 (Special Actions)** | 半脫上衣整理肩線 | `pulling the top partially off one shoulder while adjusting the fabric, one hand holding the neckline, fashion styling gesture` | 以把上衣肩線拉下一點並整理布料的造型瞬間為主，偏服裝 styling 動作而不是完整脫衣事件。 |
| **特殊動作 (Special Actions)** | 隨性癱坐在雕花單人絨布沙發上 | `lounging in a casual sprawl on an ornate carved velvet armchair, body slumped or draped across the seat, editorial location-contrast portrait action` | 以被刻意放進場景裡的雕花單人絨布沙發為核心，整體姿勢偏慵懶隨性，允許人物自然癱坐、倚靠、斜躺或半躺在沙發上，重點是鬆弛而帶企劃感的擺拍狀態。 |
| **特殊動作 (Special Actions)** | 趴臥滑手機 | `lying on her stomach with upper body propped on forearms, holding a cell phone in one hand, legs bent upward with crossed ankles, casual lounging action` | 以俯臥趴姿滑手機的放鬆瞬間為主，上半身由前臂支撐，雙腿抬起交疊，適合帶一點私密感的休閒企劃。 |
| **特殊動作 (Special Actions)** | 靠牆站立 | `standing with one side of the upper body resting against a wall, weight shifted naturally, relaxed asymmetrical wall-lean pose` | 以單側肩膀或上臂輕靠牆面的站姿為主，重點是身體重心偏向一側、姿態自然不對稱，帶有輕鬆克制的倚牆感。 |
| **特殊動作 (Special Actions)** | 靠牆坐姿 | `sitting on the floor with the full back resting against a wall, both legs extended forward, relaxed grounded wall-seated pose` | 以坐在地面、整個背部貼靠牆面、雙腿向前自然伸直的姿態為主，整體偏安靜、放空、帶一點倦懶感的靠牆坐姿。 |
| **特殊動作 (Special Actions)** | 靠牆後仰站姿 | `standing with the full back leaning against a wall, body angled into a controlled backward recline, legs supporting the weight, arms relaxed at the sides` | 以整個背部貼靠牆面、身體向後斜仰並由雙腿站立支撐的姿態為主，重點是像被牆面承接住的懸浮後仰感，以及垂直牆面與身體斜線形成的特殊張力。 |
| **特殊動作 (Special Actions)** | 靠牆仰躺抬腿 | `reclining on the floor with upper body leaned against a wall, both legs lifted upward in staggered angles, raised-leg silhouette with compressed space tension` | 以靠牆仰躺、上半身後靠、雙腿向上抬起並交錯延伸的姿態為主，重點在腿部形成的高低交錯線條與帶點壓縮空間感的擺拍張力。 |
| **特殊動作 (Special Actions)** | 側身斜躺伸腿 | `reclining on one side with upper body supported by one arm, legs stretched forward, one knee slightly bent, elongated relaxed body line` | 以側身斜躺並延伸腿部的姿態為主，強調修長線條與舞者般的舒展感，需要清楚看到整體肢體延伸。 |
| **特殊動作 (Special Actions)** | 跪姿前傾倚靠高背 | `kneeling on both knees on a seat or platform, upper body leaning forward, forearms folded across a tall backrest, supported stretched-torso pose` | 以雙膝跪在座面或平台上、上半身前傾並把前臂交疊倚靠在高處支撐物上的姿態為主，重點是前傾延伸的上半身、微微後提的臀部與被支撐住的放鬆倚靠感。 |
