...
| **姿勢與肢體語言 (Pose & Body Language)** | 半躺低姿態｜舒適正面仰躺姿勢 | `comfortable supine lying pose, lying on her back facing upward, head positioned toward the top edge of the image, feet positioned toward the bottom edge of the image, body aligned naturally along the vertical axis of the frame, both arms and legs resting casually and comfortably, calm effortless lounging stillness, upright non-inverted body orientation` | 舒服放鬆、正面朝上躺著的姿勢，頭部位於畫面上方、腳部位於畫面下方，身體自然沿畫面垂直方向延展，雙手雙腳隨性舒適地放著；只指定整體仰躺方向與放鬆狀態，不指定地面材質，避免倒置成頭下腳上的構圖。 |
