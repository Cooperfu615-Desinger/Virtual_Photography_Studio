...
| **髮型 (Hairstyle)** | 法式大波浪 | `loose voluminous waves, french style` | 蓬鬆且浪漫，帶有一點不經意的慵懶感。 |
...
| 髮色 (Hair Color) | 蜂蜜茶棕 | `honey tea brown hair, golden warm undertone` | 帶一點暖金調的茶棕色，顯得柔和明亮。 |
| 髮色 (Hair Color) | 亞麻冷棕 | `cool ash brown hair, matte smoky finish` | 冷調棕色乾淨耐看，能帶出高級與清透感。 |
| 髮色 (Hair Color) | 黑＋白金內層染 | `black hair with platinum inner layer dye` | 外層自然黑、內層白金，低調中帶有強烈層次感。 |
| 髮色 (Hair Color) | 深棕＋灰霧挑染 | `deep brown hair with smoky ash highlights` | 在深棕基底上加入灰霧挑染，時髦但不會過於誇張。 |
| 髮色 (Hair Color) | 黑＋單側銀白分色 | `black hair with one-side silver white split dye` | 一側保留深色、一側做銀白分色，視覺辨識度強。 |
| 髮色 (Hair Color) | 深髮根＋蜂蜜棕漸層 | `dark roots with honey brown gradient hair` | 從深髮根自然過渡到蜂蜜棕，層次感明顯且容易搭配。 |
| 髮色 (Hair Color) | 黑＋酒紅耳圈染 | `black hair with burgundy face-framing highlights` | 臉側耳圈區加入酒紅色，能提亮臉部輪廓。 |
| 髮色 (Hair Color) | 冷棕＋奶灰髮尾染 | `cool brown hair with milky ash dyed ends` | 整體仍偏主流冷棕，但髮尾多了柔和灰感變化。 |
| 髮色 (Hair Color) | 黑＋藍黑局部挑染 | `black hair with blue-black accent highlights` | 在黑髮中加入低調藍黑挑染，適合夜景或冷調主題。 |
| 髮色 (Hair Color) | 深棕＋玫瑰粉細挑染 | `deep brown hair with subtle rose pink highlights` | 以深棕為主體，只在局部加入玫瑰粉細挑染，甜感但不浮誇。 |
...
| **神情與眼神 (Expression & Gaze)** | 嘴角微揚神秘微笑 | `slight mysterious smile, knowing smirk, enigmatic half-smile` | 若有所思的神秘微笑，讓人捉摸不定。 |
...
| **姿勢與肢體語言 (Pose & Body Language)** | 雙手插口袋 (率性) | `hands in pockets, casual confident stance, slouched cool posture, street style` | 率性的街頭自信感，肩膀微微放鬆。 |
...
| **姿勢與肢體語言 (Pose & Body Language)** | 仰臥/俯拍躺姿 | `lying down on back, top-down aerial view, arms stretched out, dreamy resting pose` | 從正上方俯拍的躺姿，帶有夢幻輕盈的感覺。 |
