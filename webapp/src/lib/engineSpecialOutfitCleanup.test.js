...
test('special outfit reference looks 83 to 90 preserve outfit accessories and preview anchors', () => {
  const expectedByLabel = {
    ...
    白襯衫黑色氣球工裝褲造型: [
      ...
      'black extra-wide balloon cargo pants with a high-volume barrel silhouette',
      'deep knee shaping',
      'large bellows side cargo pockets',
      'panelled utility seams',
      'tapered cropped legs gathered into cuffs',
      'round eyeglasses',
      'white socks',
    ...
    白襯衫黑色長裙細領帶造型: [
      'white long-sleeve pointed-collar button-up shirt tucked neatly',
