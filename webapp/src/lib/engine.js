...
const LOCK_DEFINITIONS = [
  ...
  { key: 'poseBaseId', label: '姿勢基底', options: POSE_COMPOSER_BASE_OPTIONS, defaultValue: 'none', section: 'character' },
  { key: 'poseArrangementId', label: '肢體變化', options: POSE_COMPOSER_ARRANGEMENT_OPTIONS, defaultValue: 'none', section: 'character' },
  { key: 'poseHandId', label: '手部 / 道具動作', options: POSE_COMPOSER_HAND_OPTIONS, defaultValue: 'none', section: 'character' },
  { key: 'poseHeadId', label: '頭部方向', options: POSE_COMPOSER_HEAD_OPTIONS, defaultValue: 'none', section: 'character' },
  { key: 'poseAnchorId', label: '接觸 / 支撐', options: POSE_COMPOSER_ANCHOR_OPTIONS, defaultValue: 'none', section: 'character' },
