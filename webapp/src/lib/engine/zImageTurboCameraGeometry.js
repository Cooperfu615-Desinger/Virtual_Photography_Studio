...
const GEOMETRY_BY_CROP = Object.freeze({
  face: Object.freeze({
    ...
    left: 'Her nose, lips, and chin form one clean side contour, with her left cheek and left ear visible in a strict 90-degree left facial profile',
    ...
    right: 'Her nose, lips, and chin form one clean side contour, with her right cheek and right ear visible in a strict 90-degree right facial profile',
  ...
  upper: Object.freeze({
    ...
    left: 'Her near left shoulder visually overlaps the far right shoulder, with her upper torso seen edge-on in a strict 90-degree left-side profile',
    ...
    right: 'Her near right shoulder visually overlaps the far left shoulder, with her upper torso seen edge-on in a strict 90-degree right-side profile',
  ...
  medium: Object.freeze({
    ...
    left: 'Her near left shoulder visually overlaps the far right shoulder, with her ribcage and waist seen edge-on in a strict 90-degree left-side profile',
    ...
    right: 'Her near right shoulder visually overlaps the far left shoulder, with her ribcage and waist seen edge-on in a strict 90-degree right-side profile',
  ...
  cowboy: Object.freeze({
    ...
    left: 'Her near left shoulder visually overlaps the far right shoulder and her near left hip visually overlaps the far right hip, with her torso, pelvis, and thighs seen edge-on in a strict 90-degree left-side profile',
    ...
    right: 'Her near right shoulder visually overlaps the far left shoulder and her near right hip visually overlaps the far left hip, with her torso, pelvis, and thighs seen edge-on in a strict 90-degree right-side profile',
  ...
  full: Object.freeze({
    ...
    left: 'Her near left shoulder visually overlaps the far right shoulder and her near left hip visually overlaps the far right hip, with her torso, pelvis, legs, and feet seen edge-on in a strict 90-degree left-side profile',
    ...
    right: 'Her near right shoulder visually overlaps the far left shoulder and her near right hip visually overlaps the far left hip, with her torso, pelvis, legs, and feet seen edge-on in a strict 90-degree right-side profile',
  ...
  body: Object.freeze({
    ...
    left: 'Her near left shoulder visually overlaps the far right shoulder and her near left hip visually overlaps the far right hip, with her torso and pelvis seen edge-on in a strict 90-degree left-side profile',
    ...
    right: 'Her near right shoulder visually overlaps the far left shoulder and her near right hip visually overlaps the far left hip, with her torso and pelvis seen edge-on in a strict 90-degree right-side profile',
