...
export const POSE_COMPOSER_ARRANGEMENT_OPTIONS = [
  ...
  withLyingOrientationMatrix({ id: 'lying-body-legs-bent', base: 'lying', zh: '雙腿屈起', en: 'both knees comfortably bent and resting naturally', meta: { projectionByBucket: LYING_LOWER_BODY_PROJECTION } }),
  withLyingOrientationMatrix(withLyingUpperBodyProjectionEnglish({ id: 'lying-body-curled', base: 'lying', zh: '身體微蜷', en: 'her body gently curled inward into a compact shape', meta: { projectionByBucket: LYING_UPPER_BODY_PROJECTION } }, 'the torso gently curled into a compact shape')),
