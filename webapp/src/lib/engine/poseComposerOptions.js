...
export const POSE_COMPOSER_ARRANGEMENT_OPTIONS = [
  ...
  withLyingOrientationMatrix({ id: 'lying-body-natural-stretch', base: 'lying', zh: '自然伸展', en: 'body extended in a relaxed line with the legs resting naturally', meta: { projectionByBucket: LYING_LOWER_BODY_PROJECTION } }),
  withLyingOrientationMatrix({ id: 'lying-body-legs-bent', base: 'lying', zh: '雙腿屈起', en: 'both legs comfortably bent with the knees softly raised', meta: { projectionByBucket: LYING_LOWER_BODY_PROJECTION } }),
  withLyingOrientationMatrix(withLyingUpperBodyProjectionEnglish({ id: 'lying-body-curled', base: 'lying', zh: '身體微蜷', en: 'torso and legs gently curled inward into a compact shape', meta: { projectionByBucket: LYING_UPPER_BODY_PROJECTION } }, 'the torso gently curled into a compact shape')),
  withLyingOrientationMatrix(withLyingUpperBodyProjectionEnglish({ id: 'lying-body-half-recline', base: 'lying', zh: '上半身半躺', en: 'upper body raised into a gentle half-recline', meta: { projectionByBucket: LYING_UPPER_BODY_PROJECTION } }, 'the upper body raised into a gentle half-recline'), ['lying-supine']),
...
export const POSE_COMPOSER_ANCHOR_OPTIONS = [
  ...
  withLyingOrientationMatrix({
    ...
    phraseByOrientation: {
      'lying-supine': 'on an existing bed surface in the scene',
  ...
  withLyingOrientationMatrix({
    ...
    phraseByOrientation: {
      'lying-supine': 'on an existing tatami surface in the scene',
  ...
  withLyingOrientationMatrix({
    ...
    phraseByOrientation: {
      'lying-supine': 'on the existing indoor floor surface in the scene',
  ...
  withLyingOrientationMatrix({
    ...
    phraseByOrientation: {
      'lying-supine': 'in an empty dry bathtub, supported by its interior surface',
  ...
  withLyingOrientationMatrix({
    ...
    phraseByOrientation: {
      'lying-supine': 'on an existing sofa surface in the scene',
  ...
  withLyingOrientationMatrix({
    ...
    phraseByOrientation: {
      'lying-supine': 'on existing grass-covered ground in the scene',
  ...
  withLyingOrientationMatrix({
    ...
    phraseByOrientation: {
      'lying-supine': 'on existing concrete ground in the scene',
  ...
  withLyingOrientationMatrix({
    ...
    phraseByOrientation: {
      'lying-supine': 'on existing sand-covered ground in the scene',
