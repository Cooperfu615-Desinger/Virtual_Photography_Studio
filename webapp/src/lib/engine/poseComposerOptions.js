...
const SUPINE_SURFACE_ANCHOR_META = Object.freeze({
  supineSurfaceLed: true,
  supineEnvironmentByOrientation: Object.freeze({
    'lying-supine': '',
  }),
});

const SUPINE_SURFACE_ENVIRONMENT_TEXT = Object.freeze({
  'lying-bed-surface': 'Pillows, cushions, and a casually rumpled comforter rest on the bed, with one everyday item such as a book or phone nearby, creating a lived-in feeling.',
  'lying-tatami-surface': 'Japanese floor cushions are casually scattered across the tatami, with a Japanese magazine resting among them, adding a quiet everyday feeling.',
  'lying-floor-surface': 'A folded blanket, a drink, and one small everyday item rest nearby, keeping the floor setting simple and lived-in.',
  'lying-dry-bathtub': 'A folded towel and a few simple bath items rest nearby, keeping the dry tub setting grounded in everyday life.',
  'lying-sofa-surface': 'Loose cushions, a casually folded throw, and one everyday item such as a book or phone rest nearby, creating a lived-in feeling.',
...
export const POSE_COMPOSER_ORIENTATION_OPTIONS = [
  ...
  withLyingOrientationProjectionEnglish({ id: 'lying-supine', base: 'lying', zh: '仰躺', en: 'supine position, torso facing upward', desc: '身體腹面朝上，頭部方向與支撐物由獨立選項決定。', meta: { projectionByBucket: LYING_ORIENTATION_PROJECTION } }, 'the upper torso facing upward in a supine position', 'a supine upper-body position with the torso facing upward'),
  withLyingOrientationProjectionEnglish({ id: 'lying-side', base: 'lying', zh: '側躺', en: 'side-lying position, torso turned onto one side', desc: '身體軀幹轉向一側，頭部方向與支撐物由獨立選項決定。', meta: { projectionByBucket: LYING_ORIENTATION_PROJECTION } }, 'the upper torso turned onto one side', 'a side-lying upper-body position with the torso turned onto one side'),
  withLyingOrientationProjectionEnglish({ id: 'lying-prone', base: 'lying', zh: '趴臥', en: 'prone position, torso facing downward', desc: '身體軀幹朝下，頭部方向與支撐物由獨立選項決定。', meta: { projectionByBucket: LYING_ORIENTATION_PROJECTION } }, 'the upper torso facing downward in a prone position', 'a prone upper-body position with the torso facing downward'),
];
...
export const POSE_COMPOSER_ARRANGEMENT_OPTIONS = [
  ...
  { id: 'standing-pelvis-back-curve', base: 'standing', zh: '骨盆後推曲線站姿', en: 'curve-emphasizing standing pose, pelvis pushed strongly backward, lower back forming a pronounced arch, weight settled onto one leg, upper torso only slightly inclined forward', meta: { projectionByBucket: STANDING_LOWER_PROJECTION } },
  ...
  withSquattingUpperProjectionEnglish(
    { id: 'squatting-natural', base: 'squatting', zh: '自然蹲姿', en: 'deep resting squat with both feet planted flat, both heels grounded, knees deeply bent, and the hips held low over the feet' },
    'the torso upright and relaxed',
    'a relaxed upright upper-body posture'
  ),
  { id: 'squatting-one-knee', base: 'squatting', zh: '單膝抬起不對稱蹲姿', en: 'asymmetrical deep squat with both feet planted flat and both heels grounded, one knee lifted higher than the other while the opposite leg stays deeply bent, hips held low over the feet, creating an uneven lower-body line', meta: { projectionByBucket: SQUATTING_LOWER_PROJECTION } },
  ...
  { id: 'squatting-side', base: 'squatting', zh: '側身蹲姿', en: 'deep squat with both feet planted flat and both heels grounded, hips and legs kept low over the feet while the torso turns toward the camera', meta: { projectionByBucket: SQUATTING_LOWER_PROJECTION } },
  ...
  { id: 'squatting-low-one-leg-forward', base: 'squatting', zh: '低蹲單腿前伸', en: 'low squat with both feet planted flat on the surface and both heels grounded, one leg extended straight forward while the other leg folds under the body, hips held low over the supporting base, forming a clear asymmetrical lower-body line', meta: { projectionByBucket: SQUATTING_LOWER_PROJECTION } },
  ...
  withSquattingUpperProjectionEnglish(
    { id: 'squatting-forward-lean', base: 'squatting', zh: '身體前傾蹲姿', en: 'deep squat with both feet planted flat and both heels grounded, hips held low over the feet, and the torso leaning forward over the thighs' },
  ...
  { id: 'squatting-knees-together-low', base: 'squatting', zh: '雙膝合併半蹲', en: 'low half-squat with both feet planted flat and both heels grounded, both knees together, hips held low over the feet, and thighs held parallel', meta: { projectionByBucket: SQUATTING_KNEES_TOGETHER_PROJECTION } },
  { id: 'squatting-gangster-wide-knee', base: 'squatting', zh: '寬膝深蹲／流氓蹲姿', en: 'wide-knee deep squat with both feet planted flat in a wide stance, both heels grounded, knees opened outward, and hips held low over the feet', meta: { projectionByBucket: SQUATTING_LOWER_PROJECTION } },
  withLyingOrientationMatrix({ id: 'lying-body-natural-stretch', base: 'lying', zh: '自然伸展', en: 'her body resting in a relaxed extended line with the legs resting naturally', meta: { projectionByBucket: LYING_LOWER_BODY_PROJECTION } }),
  withLyingOrientationMatrix({ id: 'lying-body-legs-bent', base: 'lying', zh: '雙腿屈起', en: 'both of her knees comfortably bent and resting naturally', meta: { projectionByBucket: LYING_LOWER_BODY_PROJECTION } }),
  withLyingOrientationMatrix(withLyingUpperBodyProjectionEnglish({ id: 'lying-body-curled', base: 'lying', zh: '身體微蜷', en: 'her body deeply curled inward, her knees drawn close toward her chest and her spine rounded into a tight compact shape', desc: '身體大幅度蜷縮，膝蓋靠近胸口，背部形成圓弧，呈現緊密收縮的蜷曲姿勢。', meta: { projectionByBucket: LYING_UPPER_BODY_PROJECTION } }, 'the upper torso deeply curled inward, shoulders drawn toward the chest and spine rounded into a tight compact shape')),
  withLyingOrientationMatrix(withLyingUpperBodyProjectionEnglish({ id: 'lying-body-half-recline', base: 'lying', zh: '上半身半躺', en: 'her upper body slightly raised in a gentle half-recline', meta: { projectionByBucket: LYING_UPPER_BODY_PROJECTION } }, 'the upper body raised into a gentle half-recline'), ['lying-supine']),
  withLyingOrientationMatrix(withLyingUpperBodyProjectionEnglish({ id: 'lying-body-upper-propped', base: 'lying', zh: '上半身撐起', en: 'upper body raised into a supported incline', meta: { projectionByBucket: LYING_UPPER_BODY_PROJECTION } }, 'the upper body raised into a supported incline'), ['lying-side', 'lying-prone']),
  withLyingOrientationMatrix({ id: 'lying-body-supine-side-crossed', base: 'lying', zh: '下半身側轉・雙腿交疊', en: 'her waist and lower body turned to one side, both knees softly bent and the legs loosely overlapping, lying flat or slightly lifted above the surface', meta: { projectionByBucket: LYING_LOWER_BODY_PROJECTION } }, ['lying-supine']),
  withLyingOrientationMatrix({ id: 'lying-body-supine-side-separated', base: 'lying', zh: '下半身側轉・雙腿分開', en: 'her waist and lower body turned to one side, both knees softly bent and resting separately with a relaxed gap between the legs', meta: { projectionByBucket: LYING_LOWER_BODY_PROJECTION } }, ['lying-supine']),
  withLyingOrientationMatrix({ id: 'lying-body-supine-crossed-extended', base: 'lying', zh: '單腿交疊伸展', en: 'one leg extended long along the surface while the other leg bends loosely across and over it, creating an asymmetrical crossed-leg line', meta: { projectionByBucket: LYING_LOWER_BODY_PROJECTION } }, ['lying-supine']),
  withLyingOrientationMatrix({ id: 'lying-body-supine-bent-crossed', base: 'lying', zh: '雙腿屈起交疊', en: 'both of her knees bent, one heel drawn close to the hip, and one leg crossing loosely over the other in a soft asymmetrical curve', meta: { projectionByBucket: LYING_LOWER_BODY_PROJECTION } }, ['lying-supine']),
...
export const POSE_COMPOSER_HAND_OPTIONS = [
  ...
  createLyingSpecificOption({ id: 'lying-side-one-hand-near-face', zh: '側躺一手靠近臉部', en: 'upper hand resting lightly beside the cheek while the lower arm follows the body line', meta: { tags: ['lying_hand_pose', 'face_action'], visibleBuckets: HAND_VISIBLE_BUCKETS, requiresFaceVisibility: true } }, ['lying-side']),
  createLyingSpecificOption({ id: 'lying-prone-arms-along-sides', zh: '趴臥雙手沿身側伸展', en: 'both arms resting alongside the body with relaxed hands', meta: { tags: ['lying_hand_pose'], visibleBuckets: HAND_VISIBLE_BUCKETS } }, ['lying-prone']),
  createLyingSpecificOption({ id: 'lying-prone-one-hand-beside-face', zh: '趴臥一手放在臉旁', en: 'one hand resting beside the face while the other arm follows the body line', meta: { tags: ['lying_hand_pose', 'face_action'], visibleBuckets: HAND_VISIBLE_BUCKETS, requiresFaceVisibility: true } }, ['lying-prone']),
  createLyingSpecificOption({ id: 'lying-prone-hands-under-chin', zh: '趴臥雙手托在下巴下方', en: 'both hands tucked beneath the chin with relaxed elbows', meta: { tags: ['lying_hand_pose', 'face_action'], visibleBuckets: HAND_VISIBLE_BUCKETS, requiresFaceVisibility: true } }, ['lying-prone']),
  createLyingSpecificOption({ id: 'lying-prone-elbows-support', zh: '趴臥雙肘支撐上半身', en: 'both elbows planted beneath the shoulders with the forearms lifting the upper body', meta: { tags: ['lying_hand_pose', 'support_action'], visibleBuckets: HAND_VISIBLE_BUCKETS, randomEligibleForArrangements: { lying: ['lying-body-upper-propped'] } } }, ['lying-prone']),
  ...
  {
    id: 'hands-pull-open-off-shoulder-outerwear',
    zh: '雙手拉開外套（雙肩滑落）',
    en: 'both hands firmly gripping the front edges of her open outerwear near chest height and pulling them far outward while the outer layer is halfway shrugged off, its collar and shoulder seams slipped completely below both shoulders and resting around her upper arms, with both arms still loosely inside the sleeves, spreading the garment into two broad open panels',
    desc: '雙手在胸口附近緊抓敞開外套的前緣，向左右大幅拉開；外套從雙肩滑落，領口與肩線降到雙側上臂，雙臂仍套在袖內，前片展成左右兩片。',
    meta: {
      tags: ['wardrobe_action'],
      visibleBuckets: HAND_UPPER_VISIBLE_BUCKETS,
      requiresWardrobeRole: 'outerwear',
      randomEligible: false,
    },
  },
  {
...
export const POSE_COMPOSER_PROP_OPTIONS = [
  ...
  },
  {
    ...
    zh: '含著圓形棒棒糖｜右手持棒',
    en: 'a round lollipop held between her lips, the white stick extending outward with her right hand gripping the far end, cute playful pose',
    desc: '嘴裡含著圓形棒棒糖，白色棒子向外延伸，右手握住棒子最尾端，形成帶有童趣與可愛感的互動姿勢。',
    meta: { tags: ['prop_action', 'face_action'] },
  },
...
export const POSE_COMPOSER_HEAD_OPTIONS = [
  ...
  createLyingSpecificOption({ id: 'lying-supine-head-neutral', zh: '仰躺頭部自然朝上', en: 'head resting in line with the upward-facing torso', meta: { tags: ['lying_head_pose'] } }, ['lying-supine']),
  createLyingSpecificOption({ id: 'lying-supine-head-turned-side', zh: '仰躺頭部轉向一側', en: 'head turned gently to one side while the torso stays upward-facing', meta: { tags: ['lying_head_pose'] } }, ['lying-supine']),
  createLyingSpecificOption({ id: 'lying-side-head-on-support', zh: '側躺頭部貼近支撐面', en: 'head resting close to the lower shoulder line with the face angled naturally to one side', meta: { tags: ['lying_head_pose', 'support_action'] } }, ['lying-side']),
  createLyingSpecificOption({ id: 'lying-side-head-toward-camera', zh: '側躺頭部朝向鏡頭', en: 'head turned toward the camera while the torso remains side-on', meta: { tags: ['lying_head_pose'], requiresFaceVisibility: true } }, ['lying-side']),
  createLyingSpecificOption({ id: 'lying-side-head-away', zh: '側躺頭部轉向外側', en: 'head turned away from the camera along the side-facing body line', meta: { tags: ['lying_head_pose'] } }, ['lying-side']),
  createLyingSpecificOption({ id: 'lying-prone-head-turned-side', zh: '趴臥頭部轉向一側', en: 'head turned to one side while the torso stays face-down', meta: { tags: ['lying_head_pose', 'support_action'] } }, ['lying-prone']),
  createLyingSpecificOption({ id: 'lying-prone-head-toward-camera', zh: '趴臥頭部朝向鏡頭', en: 'head turned toward the camera while the torso remains face-down', meta: { tags: ['lying_head_pose'], requiresFaceVisibility: true } }, ['lying-prone']),
...
export const POSE_COMPOSER_ANCHOR_OPTIONS = [
  ...
  withLyingOrientationMatrix({
    ...
    base: 'lying',
    zh: '床上',
    en: 'lying on a bed that dominates the composition',
    meta: {
      tags: ['lying_support', 'indoor_support'],
      requiresSceneType: 'indoor',
      ...SUPINE_SURFACE_ANCHOR_META,
      supineEnvironmentByOrientation: { 'lying-supine': SUPINE_SURFACE_ENVIRONMENT_TEXT['lying-bed-surface'] },
      projectionByBucket: LYING_SUPPORT_PROJECTION,
    },
    phraseByOrientation: {
      'lying-supine': 'on a bed that dominates the composition',
      'lying-side': 'on an existing bed surface in the scene',
      'lying-prone': 'on an existing bed surface in the scene',
    },
  }),
  withLyingOrientationMatrix({
    ...
    base: 'lying',
    zh: '榻榻米上',
    en: 'lying on tatami that dominates the composition',
    meta: {
      tags: ['lying_support', 'indoor_support'],
      requiresSceneType: 'indoor',
      ...SUPINE_SURFACE_ANCHOR_META,
      supineEnvironmentByOrientation: { 'lying-supine': SUPINE_SURFACE_ENVIRONMENT_TEXT['lying-tatami-surface'] },
      projectionByBucket: LYING_SUPPORT_PROJECTION,
    },
    phraseByOrientation: {
      'lying-supine': 'on tatami that dominates the composition',
      'lying-side': 'on an existing tatami surface in the scene',
      'lying-prone': 'on an existing tatami surface in the scene',
    },
  }),
  withLyingOrientationMatrix({
    ...
    base: 'lying',
    zh: '地板上',
    en: 'lying on an indoor floor that dominates the composition',
    meta: {
      tags: ['lying_support', 'indoor_support'],
      requiresSceneType: 'indoor',
      ...SUPINE_SURFACE_ANCHOR_META,
      supineEnvironmentByOrientation: { 'lying-supine': SUPINE_SURFACE_ENVIRONMENT_TEXT['lying-floor-surface'] },
      projectionByBucket: LYING_SUPPORT_PROJECTION,
    },
    phraseByOrientation: {
      'lying-supine': 'on an indoor floor that dominates the composition',
      'lying-side': 'on the existing indoor floor surface in the scene',
      'lying-prone': 'on the existing indoor floor surface in the scene',
    },
  }),
  withLyingOrientationMatrix({
    ...
    base: 'lying',
    zh: '浴缸內（無水）',
    en: 'lying inside a dry bathtub that dominates the composition',
    meta: {
      tags: ['lying_support', 'indoor_support'],
      requiresSceneType: 'indoor',
      ...SUPINE_SURFACE_ANCHOR_META,
      supineEnvironmentByOrientation: { 'lying-supine': SUPINE_SURFACE_ENVIRONMENT_TEXT['lying-dry-bathtub'] },
      projectionByBucket: LYING_SUPPORT_PROJECTION,
    },
    phraseByOrientation: {
      'lying-supine': 'inside a dry bathtub that dominates the composition',
      'lying-side': 'in an empty dry bathtub, supported by its interior surface',
      'lying-prone': 'in an empty dry bathtub, supported by its interior surface',
    },
  }),
  withLyingOrientationMatrix({
    ...
    base: 'lying',
    zh: '沙發上',
    en: 'lying on a sofa that dominates the composition',
    meta: {
      tags: ['lying_support', 'indoor_support'],
      requiresSceneType: 'indoor',
      ...SUPINE_SURFACE_ANCHOR_META,
      supineEnvironmentByOrientation: { 'lying-supine': SUPINE_SURFACE_ENVIRONMENT_TEXT['lying-sofa-surface'] },
      projectionByBucket: LYING_SUPPORT_PROJECTION,
    },
    phraseByOrientation: {
      'lying-supine': 'on a sofa that dominates the composition',
      'lying-side': 'on an existing sofa surface in the scene',
      'lying-prone': 'on an existing sofa surface in the scene',
    },
  }),
  withLyingOrientationMatrix({
    ...
    base: 'lying',
    zh: '草地上',
    en: 'lying on grass that dominates the composition',
    meta: {
      tags: ['lying_support', 'outdoor_support'],
      requiresSceneType: 'outdoor',
      ...SUPINE_SURFACE_ANCHOR_META,
      supineEnvironmentByOrientation: { 'lying-supine': SUPINE_SURFACE_ENVIRONMENT_TEXT['lying-grass-ground'] },
      projectionByBucket: LYING_SUPPORT_PROJECTION,
    },
    phraseByOrientation: {
      'lying-supine': 'on grass that dominates the composition',
      'lying-side': 'on existing grass-covered ground in the scene',
      'lying-prone': 'on existing grass-covered ground in the scene',
    },
  }),
  withLyingOrientationMatrix({
    ...
    base: 'lying',
    zh: '水泥地上',
    en: 'lying on concrete that dominates the composition',
    meta: {
      tags: ['lying_support', 'outdoor_support'],
      requiresSceneType: 'outdoor',
      ...SUPINE_SURFACE_ANCHOR_META,
      supineEnvironmentByOrientation: { 'lying-supine': SUPINE_SURFACE_ENVIRONMENT_TEXT['lying-concrete-ground'] },
      projectionByBucket: LYING_SUPPORT_PROJECTION,
    },
    phraseByOrientation: {
      'lying-supine': 'on concrete that dominates the composition',
      'lying-side': 'on existing concrete ground in the scene',
      'lying-prone': 'on existing concrete ground in the scene',
    },
  }),
  withLyingOrientationMatrix({
    ...
    base: 'lying',
    zh: '沙地上',
    en: 'lying on a fine white-sand beach that dominates the composition',
    meta: {
      tags: ['lying_support', 'outdoor_support'],
      requiresSceneType: 'outdoor',
      ...SUPINE_SURFACE_ANCHOR_META,
      supineEnvironmentByOrientation: { 'lying-supine': SUPINE_SURFACE_ENVIRONMENT_TEXT['lying-sand-ground'] },
      projectionByBucket: LYING_SUPPORT_PROJECTION,
    },
    phraseByOrientation: {
      'lying-supine': 'on a fine white-sand beach that dominates the composition',
      'lying-side': 'on existing sand-covered ground in the scene',
      'lying-prone': 'on existing sand-covered ground in the scene',
    },
  }),
  withLyingOrientationMatrix({
    ...
    meta: {
      ...
      requiresSceneType: 'outdoor',
      ...SUPINE_SURFACE_ANCHOR_META,
      supineEnvironmentByOrientation: { 'lying-supine': SUPINE_SURFACE_ENVIRONMENT_TEXT['lying-clear-sea-surface'] },
      projectionByBucket: LYING_SUPPORT_PROJECTION,
    },
    phraseByOrientation: {
