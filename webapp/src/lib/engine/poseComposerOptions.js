...
export const POSE_COMPOSER_HAND_OPTIONS = [
  ...
  { id: 'hand-apply-lipstick', zh: '塗口紅', en: 'one hand pressing a lipstick bullet to the lips, with visible hand-to-mouth contact and slight lip pressure', desc: '手持口紅接觸嘴唇，保留明確補妝接觸點。', meta: { tags: ['prop_action', 'face_action'] } },
  { id: 'hand-messy-lipstick', zh: '塗歪口紅', en: 'one hand applying lipstick messily beyond the lip line, with visible hand-to-mouth contact', desc: '手持口紅塗出唇線外，保留不完美補妝效果。', meta: { tags: ['prop_action', 'face_action'] } },
...
export const POSE_COMPOSER_ANCHOR_OPTIONS = [
  ...
  { id: 'kneeling-hands-ground', base: 'kneeling', zh: '雙手支撐在地面', en: 'with both hands planted on the ground for support' },
