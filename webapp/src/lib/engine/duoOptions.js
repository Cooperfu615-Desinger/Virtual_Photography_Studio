...
export const DUO_EXPRESSION_OPTIONS = [
  ...
  {
    id: 'direct-calm-unsmiling',
    zh: '兩人直視鏡頭｜平靜冷淡',
    en: 'both women look directly at the camera with calm unsmiling expressions, cool emotional distance, composed editorial presence',
    meta: { tags: ['direct_gaze'] },
  },
  {
    id: 'direct-gentle-smile',
    zh: '兩人直視鏡頭｜柔和微笑',
    en: 'both women look directly at the camera with gentle warm smiles, friendly shared presence, relaxed openness',
    meta: { tags: ['direct_gaze'] },
  },
  {
    id: 'mutual-gaze-intimate',
    zh: '兩人相互凝視｜安靜親密',
    en: 'both women look directly at each other with quiet intimate expressions, calm private connection',
  },
  {
    id: 'mutual-laughing-natural',
    zh: '兩人相互大笑｜自然開心',
    en: 'both women look at each other and laugh openly, spontaneous joyful faces, lively shared connection',
  },
  {
    id: 'one-camera-one-partner',
    zh: '一人看鏡頭｜一人看對方',
    en: 'one woman looks directly at the camera while the other looks at her, asymmetrical relational gaze',
    meta: { tags: ['direct_gaze'] },
  },
  {
    id: 'one-camera-one-away',
    zh: '一人看鏡頭｜一人隨性離鏡',
    en: 'one woman looks directly at the camera while the other looks away from the camera, asymmetrical off-camera attention',
    meta: { tags: ['direct_gaze'] },
  },
  {
    id: 'same-direction-shared-attention',
    zh: '兩人同向離鏡｜共同注意',
    en: 'both women look away from the camera in the same direction, shared attention beyond the frame',
  },
  {
    id: 'different-directions-away',
    zh: '兩人各自離鏡｜個別分心',
    en: 'both women look away in different directions, each absorbed in a separate off-camera thought',
  },
  {
    ...
    meta: { uiHidden: true, tags: ['legacy', 'direct_gaze'] },
  },
  {
  ...
  },
  {
    ...
    meta: { uiHidden: true, tags: ['legacy'] },
  },
  {
