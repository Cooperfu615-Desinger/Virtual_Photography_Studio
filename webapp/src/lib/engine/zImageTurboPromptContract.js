...
export const Z_IMAGE_TURBO_PROMPT_CONTRACT = deepFreeze({
  ...
  singleSceneIntegrated: {
    ...
    independentAnchor: 'omit relational anchors from Z-only projected sources; retain source-marked concrete support objects from manual sitting selections; preserve selection and shared canonical',
