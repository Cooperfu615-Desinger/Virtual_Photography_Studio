...
export const LOCAL_DETAIL_PROMPT_CONTRACT = deepFreeze({
  ...
  targets: {
    eyes: {
      ...
      framingIntent: 'browLineToUpperCheekbonesWithBothEyesWithoutCompleteFace',
    },
    'collarbone-chest': {
      label: '鎖骨／胸口',
      subregions: ['neckBase', 'collarbone', 'upperChest'],
      allowedGroups: ['bodyContour', 'localSkin', 'localHairOcclusion', 'localFabric', 'localColor', 'localNeckline', 'localStraps', 'effectiveCoverageModifiers', 'visibleNeckAccessory'],
      ignoredAccessoryGroups: ['eyewear', 'earrings', 'waistAccessory'],
      framingIntent: 'neckBaseToUpperBustWithCollarbonesWithoutFaceOrWaist',
    },
    'abdomen-navel': {
      label: '腰腹／肚臍',
      subregions: ['navelPosition', 'surroundingAbdomen', 'nearbyWaistline'],
      allowedGroups: ['bodyContour', 'localSkin', 'localFabric', 'localColor', 'localWaistline', 'effectiveCoverageModifiers', 'visibleWaistAccessory', 'visibleNavelPiercing'],
      ignoredAccessoryGroups: ['eyewear', 'earrings', 'neckAccessory'],
      framingIntent: 'lowerRibcageToUpperHipWithNavelAndWaistContours',
    },
  },
  storageTarget: {
